...
public class ProceduralShapeBezier : ProceduralAbstractSoRShape
{
    ...
    private static float[][] shapePresets
        = new float[][] { 
            ...
            new float[] { 0.4f, 0.001f, 1.0f, 0.6f }, // 1
            new float[] { 0.5f, 0.001f, 0.8f, 0.7f }, // 3
            new float[] { 0.4f, 0.2f, 0.8f, 0.6f }, // 2
            new float[] { 0.3f, 0.2f, 1.0f, 0.5f }, // 4
            new float[] { 0.1f, 0.001f, 0.7f, 2f/3f }, // 6
            new float[] { 1f/3f, 0.3f, 1.0f, 0.9f } // 7
        };

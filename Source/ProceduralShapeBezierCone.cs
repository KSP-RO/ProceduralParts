...
namespace ProceduralParts
{
    public class ProceduralShapeBezierCone : ProceduralAbstractShape
    {
        ...
        [KSPField(isPersistant = true, guiActiveEditor = true, guiName = "#PP_plugin_Shape_Curve", groupName = ProceduralPart.PAWGroupName),
         UI_ChooseOption(scene = UI_Scene.Editor)]
        public string selectedShape;

        [KSPField(isPersistant = true, guiActiveEditor = true, guiActive = false, guiName = "#PP_plugin_Shape_Top", guiFormat = "F3", guiUnits = "m", groupName = ProceduralPart.PAWGroupName),
         UI_FloatEdit(scene = UI_Scene.Editor, incrementSlide = SliderPrecision, sigFigs = 5, unit = "m", useSI = true)]
        public float topDiameter = 1.25f;

        [KSPField(isPersistant = true, guiActiveEditor = true, guiActive = false, guiName = "#PP_plugin_Shape_Bottom", guiFormat = "F3", guiUnits = "m", groupName = ProceduralPart.PAWGroupName),
         UI_FloatEdit(scene = UI_Scene.Editor, incrementSlide = SliderPrecision, sigFigs = 5, unit = "m", useSI = true)]
        ...
        [KSPField(isPersistant = true, guiActiveEditor = true, guiName = "#PP_plugin_Shape_Offset", guiFormat = "F3", guiUnits = "m", groupName = ProceduralPart.PAWGroupName),
         UI_FloatEdit(scene = UI_Scene.Editor, incrementSlide = SliderPrecision, sigFigs = 5, unit = "m", useSI = true)]
        ...
        public override void UpdateTechConstraints()
        {
            ...
            else
            {
                ...
                {
                    Fields[nameof(topDiameter)].guiActiveEditor = false;
                    Fields[nameof(bottomDiameter)].guiName = "#PP_plugin_Shape_Diameter";
                }
                if (coneBottomMode == ConeEndMode.Constant)
                {
                    Fields[nameof(bottomDiameter)].guiActiveEditor = false;
                    Fields[nameof(topDiameter)].guiName = "#PP_plugin_Shape_Diameter";
                }
            }
